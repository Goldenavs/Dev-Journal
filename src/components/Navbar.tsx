...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <a href="#contact" className="px-5 py-2.5 text-sm font-black uppercase tracking-wide bg-orange-500 text-black rounded-full hover:bg-orange-400 hover:scale-105 transition-all duration-300">
        Let's Talk
      </a>
    </motion.nav>
  );
