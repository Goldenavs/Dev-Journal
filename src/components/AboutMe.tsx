...
const PhotoFrame = ({ 
  ...
  return (
    <motion.div 
      ...
      className={`group absolute flex flex-col bg-[#050505]/80 backdrop-blur-xl border border-white/10 shadow-[0_0_20px_rgba(0,0,0,0.8)] transition-all duration-500 hover:border-orange-500/40 hover:shadow-[0_0_30px_rgba(249,115,22,0.15)] p-1.5 md:p-2 ${className}`}
    >
      ...
      {/* Schematic Top Bar */}
      <div className="flex-none flex items-center justify-between px-1 md:px-2 pb-1.5 md:pb-2 mb-1.5 md:mb-2 border-b border-white/10 w-full group-hover:border-orange-500/30 transition-colors duration-500">
        <span className="font-orbitron text-[7px] md:text-[9px] text-neutral-500 uppercase tracking-[0.2em] group-hover:text-orange-500 transition-colors">
          {sysId}
        </span>
        <div className="flex gap-1">
          <div className="w-1 md:w-1.5 h-1 md:h-1.5 bg-neutral-700 group-hover:bg-orange-500 transition-colors duration-500 animate-pulse" />
          <div className="w-1 md:w-1.5 h-1 md:h-1.5 bg-neutral-800 group-hover:bg-orange-500/40 transition-colors duration-500" />
        </div>
      </div>
...
const AboutMe = () => {
  ...
  return (
    // FIX 1: Changed from `py-20` to `pt-20 pb-40` for huge bottom padding on mobile
    <section ref={containerRef} className="min-h-screen flex items-center justify-center pt-20 pb-40 md:py-32 px-4 md:px-6 relative z-10 overflow-hidden">
      ...
      <motion.div 
        ...
        className="font-montserrat absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[15vw] md:text-[10vw] font-black uppercase text-white/[0.02] tracking-tighter pointer-events-none -z-20 whitespace-nowrap"
      >
        ENGINEER
      </motion.div>
      ...
      <motion.div 
        ...
        className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center"
      >
        ...
        >
          ...
          <div className="space-y-6 text-base md:text-xl text-neutral-400 font-light leading-relaxed mt-4">
            ...
            >
              ...
              <p className="relative z-10 italic text-neutral-300 font-light leading-relaxed text-sm md:text-base">
          ...
          <motion.div variants={textVariants} className="mt-12 flex items-center justify-between max-w-lg">
             <div className="flex flex-col items-center justify-center group cursor-default px-2">
               <span className="font-orbitron text-3xl md:text-5xl font-black text-shine-fx group-hover:scale-110 group-hover:drop-shadow-[0_0_15px_rgba(249,115,22,0.8)] transition-all duration-500">
                 3rd
               </span>
               <span className="font-orbitron text-[8px] md:text-xs uppercase tracking-widest text-neutral-500 group-hover:text-orange-500 font-bold mt-2 transition-colors duration-500 text-center">Year Student</span>
             </div>
             ...
             <div className="flex flex-col items-center justify-center group cursor-default px-2">
               ...
               <span className="font-orbitron text-[8px] md:text-xs uppercase tracking-widest text-neutral-500 group-hover:text-orange-500 font-bold mt-2 transition-colors duration-500 text-center">Lines of Code</span>
             </div>
             ...
             <div className="flex flex-col items-center justify-center group cursor-default px-2">
               ...
               <span className="font-orbitron text-[8px] md:text-xs uppercase tracking-widest text-neutral-500 group-hover:text-orange-500 font-bold mt-2 transition-colors duration-500 text-center">Sleep Not Found</span>
             </div>
          </motion.div>
        </motion.div>

        {/* RIGHT COLUMN: The Kinetic Architectural Gallery */}
        {/* FIX 2: Increased height to 400px and added `mb-12` on mobile to give more breathing room */}
        <div className="relative w-full h-[400px] sm:h-[450px] md:h-[600px] mt-12 lg:mt-0 mb-12 lg:mb-0 perspective-1000">
          <PhotoFrame 
            src="/me-1.jpg"
            alt="Main Portrait"
            sysId="SYS.IMG.01 // MAIN_VIEW"
            className="w-[200px] h-[260px] sm:w-[240px] sm:h-[320px] md:w-[300px] md:h-[400px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 rotate-[-2deg]"
          ...
          <PhotoFrame 
            ...
            // FIX 3: Changed top-[0%] to top-[10%] so it doesn't scrape the very top boundary
            className="w-[140px] h-[180px] sm:w-[180px] sm:h-[240px] md:w-[220px] md:h-[280px] top-[10%] right-[0%] md:top-[5%] md:right-[5%] z-10 rotate-[6deg]"
            scrollYProgress={scrollYProgress}
            yOffset={[60, -60]} 
          />
          <PhotoFrame 
            ...
            // FIX 3: Changed bottom-[0%] to bottom-[10%] so the parallax scroll animation doesn't push it out of bounds
            className="w-[120px] h-[150px] sm:w-[160px] sm:h-[200px] md:w-[200px] md:h-[250px] bottom-[10%] left-[0%] md:bottom-[5%] md:left-[5%] z-30 rotate-[-8deg]"
            scrollYProgress={scrollYProgress}
            yOffset={[-30, 60]} 
          />
        </div>
